...
//    },
    ...
    function (session, results) {
        ...
        var mvcmd = 'mv /app/issues.xml /tmp';
        ...
        var sedcmd = 'sed -i "s/this is the 10th bug for Alfred./' + session.userData.subject + '/g" /tmp/issues.xml';
        ...
        var cmd = 'curl -v -H "Content-Type: application/xml" -X POST --data-binary "@/tmp/issues.xml" -u "eitc:secret"  https://b72c4b06.ngrok.io/issues.xml?key=678fb5bd075ebee0a4636b74857cb6b0ece71cf3';
